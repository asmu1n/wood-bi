...
func (_q *UserQuery) QueryCharts() *ChartQuery {
...
func (_q *UserQuery) WithCharts(opts ...func(*ChartQuery)) *UserQuery {
	query := (&ChartClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withCharts; query != nil {
		if err := _q.loadCharts(ctx, query, nodes,
			func(n *User) { n.Edges.Charts = []*Chart{} },
			func(n *User, e *Chart) { n.Edges.Charts = append(n.Edges.Charts, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadCharts(ctx context.Context, query *ChartQuery, nodes []*User, init func(*User), assign func(*User, *Chart)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(chart.FieldUserID)
	}
	query.Where(predicate.Chart(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.ChartsColumn), fks...))
	}))
